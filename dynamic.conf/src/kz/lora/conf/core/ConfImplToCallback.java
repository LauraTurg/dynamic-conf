...
import kz.lora.conf.core.fields.ConfIgnore;
import kz.lora.conf.core.fields.FieldAccess;
import kz.lora.conf.core.fields.FieldDef;
import kz.lora.conf.core.fields.FieldDefParserDefault;
import kz.lora.conf.core.fields.FieldParserDefault;
import kz.lora.conf.hot.DefaultListSize;
import kz.lora.conf.hot.Description;
import kz.lora.conf.hot.FirstReadEnv;
import kz.lora.conf.core.util.UnionDescriptions;
...
import static kz.lora.conf.ConfUtil.convertToType;
import static kz.lora.conf.ConfUtil.convertibleTypeList;
import static kz.lora.conf.ConfUtil.extractStrDefaultValue;
import static kz.lora.conf.ConfUtil.findAnnotation;
import static kz.lora.conf.ConfUtil.isConvertingType;
  ...
  private void appendContent(ConfContent confContent, String prefix, Description superDescription) {
    {
      ...
      List<String> descriptionLines = UnionDescriptions.unionDescriptions(description, superDescription);
    ...
    for (Method method : interfaceClass.getMethods()) {
      ...
      {
        List<String> lines = UnionDescriptions.unionDescriptions(findAnnotation(returnType, Description.class), description);

package kz.lora.conf.zookeeper;

import kz.lora.conf.core.ConfAccess;
import kz.lora.conf.hot.AbstractHotConfFactory;
...
public abstract class AbstractZookeeperConfigFactory extends AbstractHotConfFactory
  ...
  protected <T> ConfAccess confAccess(Class<T> configInterface) {
    return new ZookeeperConfAccess(
        extractConfigPath(configInterface), this::client, this::confContentSerializer);
  }
